...
export default function ProjectsSection() {
    return (
      <section className="bg-gray-100 p-10">
        <h2 className="text-4xl font-bold text-left mb-10">Proyectos</h2>
        <div className="flex flex-col space-y-14 max-w-6xl mx-auto">
          {projects.map((project) => (
            ...
            >
              {/* Imagen del Proyecto */}
              <div className="bg-red-300 p-0.5 flex justify-center items-center md:w-1/3">
              ...
              <div className="p-5 flex flex-col justify-between md:w-2/3">
                ...
                <div className="flex space-x-7 mt-4 pt-4 border-t border-gray-200">
                  {project.technologies.map((tech, index) => (
                    <img key={index} src={tech} alt="Technology" className="w8- h-8" />
                  ))}
                </div>
              </div>
            </div>
